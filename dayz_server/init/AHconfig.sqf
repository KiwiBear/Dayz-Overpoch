...
/*  SUPER ADMIN HERE      */ _SAdmins = ["76561198003411083","76561198037761124","76561197970322107","76561198023876576"]; //do not have a , at the end.
...
[
	...
	"BTC_Hud","PlotManagement","#USER:_keyMenu","#USER:ActionMenu","#USER:ActionMenua",
	"#USER:SkyMenu","#USER:FogMenu","#USER:SkyMenu2","#USER:FogMenu2","#USER:DeployMenu","#USER:_DeployMenu",'#USER:GestureMenu','#USER:ToolMenu','#USER:Info','#USER:DonatorMenu','#USER:BuildingMenu','#USER:SurvivalMenu','#USER:OtherMenu','#USER:ActionMenua2','#USER:SkyMenu3','#USER:SkyMenu4','#USER:FunMenu'
];
