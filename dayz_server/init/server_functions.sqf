...
call compile preProcessFileLineNumbers "\z\addons\dayz_server\CUSTOMMAPS\nwaf2.sqf";
...
//call compile preProcessFileLineNumbers "\z\addons\dayz_server\CUSTOMMAPS\highgrass.sqf";         //too laggy
