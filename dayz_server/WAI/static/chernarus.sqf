if(isServer) then {
 ...
 //====================PRISON AI BY BLUETESLA======================



[[[1332.7169, 4036.4258, 17.077812],[1314.8441, 4117.3589,0],[1397.4993, 4085.823, 2.3561983],[1353.5906, 4062.3684,0],[1375.5137, 4018.2834, 6.4955416],[1382.8082, 4034.0393, 3.5263901]],"M2StaticMG","random","TK_CIV_Worker02_EP1","Bandit","Random",2,"Random","Random"] call spawn_static;
[[[1339.0088, 4090.4382, 6.3388557]],"ZU23_Gue","easy","TK_CIV_Worker02_EP1","Bandit","Random",2,"Random","Random"] call spawn_static;  //Luftabwehreinrichtung
[[[1363.2904, 3987.6414, 3.2776139],[1344.1532, 4085.6086, 11.078203]],"TOW_TriPod","random","TK_CIV_Worker02_EP1","Bandit","Random",2,"Random","Random"] call spawn_static;  //Panzerabwehrgeschuetze

_AnzahlPolizei1 = 2 + round (random 3);
_AnzahlPolizei2 = 2 + round (random 3);
_AnzahlWookies1 = 5 + round (random 5);
_AnzahlWookies2 = 5 + round (random 5);

[[1381.4525, 4006.1001,1],_AnzahlPolizei1,"Random","cqc",4,"Random","RU_Policeman_DZ","Random","Bandit"] call spawn_group;    //Polizei 1
[[1389.0601, 4068.9724,1],_AnzahlPolizei2,"Random","cqc",4,"Random","RU_Policeman_DZ","Random","Bandit"] call spawn_group;    //Polizei 2
[[1327.1628, 4112.2407,1],_AnzahlWookies1,"Random","cqc",4,"Random","TK_CIV_Worker02_EP1","Random","Bandit"] call spawn_group;    //Waldlaeufer 1
[[1295.9736, 4111.29,1],_AnzahlWookies2,"Random","cqc",4,"Random","TK_CIV_Worker02_EP1","Random","Bandit"] call spawn_group;    //Waldlaeufer 2
[[1295.9736, 4111.29,10],1,"extreme","boss",10,"DZ_LargeGunBag_EP1","Sniper1_DZ","Random","Bandit"] call spawn_group;    //Sniper Boss !!!
