if(isServer) then {
	...
	/* AI CONFIG */
		...
		ai_cleanup_time 			= 1400;			// time to clear bodies in seconds
		...
		ai_static_weapons			= ["KORD_high_TK_EP1","DSHKM_Ins","M2StaticMG","ZU23_Gue","TOW_TriPod"];	// static guns ++ edit by blueTesla ++
...
ai_wep_assault						= ["M16A4_ACG","Sa58V_RCO_EP1","SCAR_L_STD_Mk4CQT","M4A1_HWS_GL_camo","SCAR_L_STD_HOLO","M4A3_CCO_EP1","M4A3_CCO_EP1","M4A1_AIM_SD_camo","M16A4","m8_carbine","BAF_L85A2_RIS_Holo","Sa58V_CCO_EP1"];	// Assault
		...
		ai_wep_sniper_boss			= ["BAF_AS50_scoped","M107_DZ","KSVK_DZE"];	// BOSSSniper rifles
		ai_wep_cqc            		= ["Saiga12K","AA12_PMC","M1014","MP5SD","vil_uzi_c","vil_uzi","vil_uzi_SD","Remington870","Remington870_lamp","MR43","bizon_silenced","Winchester1866"]; //close quarter combat by blueTesla
	...
	/* WAI MISSIONS CONFIG */
		...
		wai_avoid_missions			= 650;								// avoid spawning missions this close to other missions, these are defined in wai_mission_markers
		wai_avoid_traders			= 450;								// avoid spawning missions this close to traders
		...
		wai_mission_timer			= [540,900];							// time between missions 5-15 minutes
